...
Everyone wants their cake and wants to eat it too. Especially when you have around 100 cores per multisocket socket machine with few TB of RAM loaded with tens of TB NVMEs. Request to get a shared cluster of everything is not so uncommon.  

## NUMA
To avoid interfering with different services, it seems plausible to sort the running process.  
It also disciplines rogue clients and helps service providers with QOS management.  
