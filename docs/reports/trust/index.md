...
To put an almost successful scam story short. Do not trust what you [see](../../varia/assets/tampered.png)! It may be a "legitimate" document from known sources.
...
And then let's generate the publicly shareable file ( via the company webpage):
```
